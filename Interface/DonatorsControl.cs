...
namespace Interface
{
    public partial class DonatorsControl : UserControl
    {
        ...
        public void ReloadListView()
        {
            ...
            var donators = client.GetDonators();
        ...
        private void CarregarDadosTabela(ServiceReference1.Donator[] donators)
        {
        ...
        {
            if (compatibilityComboBox.Text.Equals("All"))
            {
                dv.RowFilter = "";
                CarregarDataProcura(dv);
            }
            if (compatibilityComboBox.Text.Equals("A+"))
            {
            ...
            if (compatibilityComboBox.Text.Equals("O+"))
            {
        ...
        {
            if (SearchBox.Text.Equals("male") && FilterBox.Text.Equals("Sexo"))
            {
                dv.RowFilter = "(Sexo ='Male')";
                CarregarDataProcura(dv);
            }
            ...
            if (listView1.SelectedItems.Count > 0)
            {
                        ...
                        "Delete donator!", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    foreach (ListViewItem item in listView1.SelectedItems)
                    {
                        ...
                        if (client.RemoverDonator(item.Text)==false)
                        { 
